...
- **Performance prediction** — ARIMA-based model to forecast a player's next game stats *(work in progress)*
...
| `!predict_performance <player>` | Predict a player's next game stats using ARIMA *(work in progress)* | `!predict_performance Jayson Tatum` |
